...
@section('content')
    <div class="card">
        ...
        <div class="card-body text-center">
            <p class="card-text">To continue, please log in below, or <a href="{{ route('site.home') }}">return to the main site</a>.</p>
            <a href="{{ route('login.vatsim') }}" class="btn btn-lg btn-primary"
